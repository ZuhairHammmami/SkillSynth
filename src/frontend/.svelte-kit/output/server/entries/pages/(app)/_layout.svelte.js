import { f as fallback, a as attr, c as bind_props, d as attr_class, s as store_get, u as unsubscribe_stores, e as ensure_array_like, g as escape_html } from "../../../chunks/index.js";
...
const localeStore = writable({ locale: "en", dir: "ltr" });
function LocaleSwitcher($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    $$renderer2.push(`<button class="switch svelte-npjipv" aria-label="Switch language"><span${attr_class("dot svelte-npjipv", void 0, {
      "on": store_get($$store_subs ??= {}, "$localeStore", localeStore).locale === "ar"
    })}>ع</span> <span class="bar svelte-npjipv"></span> <span${attr_class("dot svelte-npjipv", void 0, {
      "on": store_get($$store_subs ??= {}, "$localeStore", localeStore).locale === "en"
    })}>EN</span></button>`);
