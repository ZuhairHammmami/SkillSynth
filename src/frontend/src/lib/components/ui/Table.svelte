<!-- Styled table. Plain <table class="ss-table"> in pages; this wrapper adds
     warm-craft chrome (hairline rules, generous spacing, zebra striping).
     Add scope="col"/"row" to <th> and aria-sort to sortable headers. -->
<script lang="ts">
