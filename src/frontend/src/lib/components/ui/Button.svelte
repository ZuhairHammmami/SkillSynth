...
<style>
  ...
  .primary { background: var(--ochre); color: #fff; border-color: var(--ochre-deep); box-shadow: var(--shadow-sm); }
  .primary:hover:not(:disabled) { background: var(--ochre-deep); box-shadow: var(--shadow), 0 2px 8px color-mix(in srgb, var(--ochre) 30%, transparent); }
  .primary:active:not(:disabled) { background: color-mix(in srgb, var(--ochre-deep) 88%, var(--ink)); border-color: color-mix(in srgb, var(--ochre-deep) 88%, var(--ink)); transform: translateY(1px); box-shadow: none; }
  .primary:hover:not(:disabled):focus-visible { box-shadow: 0 0 0 3px var(--focus-glow), 0 2px 8px color-mix(in srgb, var(--ochre) 30%, transparent); }
  ...
  .link { background: transparent; color: var(--ochre-deep); border-color: transparent; padding-inline: 0; min-height: 0; }
