...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      >
        <Logo />
        <h1 className="mt-6 text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-primary via-blue-600 to-secondary sm:text-6xl md:text-7xl">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">القوة بين يديك</h2>
