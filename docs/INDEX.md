...
| 44 | [Test Scenarios](44-test-scenarios/INDEX.md) | Suite map: 199 tests / 21 files |
...
- **Tests**: `PYTHONPATH=src python -m pytest tests/ -q` — 199 passed, isolated temp DB per run
